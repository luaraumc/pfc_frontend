		...
		<div className="min-h-screen bg-slate-900 text-slate-200">
			...
			{vagaExcluir && (
				<div className="fixed inset-0 flex items-center justify-center z-50">
					<div className="absolute inset-0 bg-black opacity-50" onClick={cancelarExclusaoVaga}></div>
					<div className="bg-slate-800 rounded-lg overflow-hidden shadow-lg max-w-sm w-full z-10">
						<div className="p-5">
							...
							<p className="text-sm text-slate-400 mb-6">
								Tem certeza que deseja excluir a vaga "<span className="font-medium text-slate-200">{vagaExcluir.titulo}</span>"?
							</p>
